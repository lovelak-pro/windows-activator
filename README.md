# Instant Windows 10 & 11 Activator: in only 10-Second.


> This repository contains a way that can activate Windows 10 and 11 in under 10 seconds. is compatible with home, home N, Home single lang, Home country specific, professional, education and enterprise versions of Windows.

 
### Instant Windows activation using (PowerShell)  
> [!TIP]
> We have many ways to run powershell in windowss 10 & 11.
